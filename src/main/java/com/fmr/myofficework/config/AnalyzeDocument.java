...
public class AnalyzeDocument extends JPanel {
    ...
    public static void extractPdf() throws Exception{
        ...
        AmazonS3 s3client = AmazonS3ClientBuilder.standard()
                .withEndpointConfiguration(
                        new EndpointConfiguration("https://s3.console.aws.amazon.com/s3/ap/248349112332/myofficework?region=us-east-2","us-east-2"))
                .build();
        ...
        EndpointConfiguration endpoint = new EndpointConfiguration(
                "https://s3.console.aws.amazon.com/s3/ap/248349112332/myofficework?region=us-east-2", "us-east-2");
